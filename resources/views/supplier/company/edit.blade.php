@if(isset($user_company->id))
    {!! Form::model($user_company, ['route' => ["$route.update", $user_company->uuid], 'method'=>'PUT','id'=>'form','class'=>'theme-form','autocomplete' => 'off', 'name' => 'usersForm']) !!}
@else
    {!! Form::model($user_company, ['route' => ["$route.store",], 'id'=>'form', 'autocomplete' => 'off', 'name' => 'usersForm','class'=>'theme-form']) !!}
@endif
...
@endif
{!! Form::hidden('owner_user_id', auth()->user()->uuid) !!}
<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::text("legal_name",null,["class"=>"form-control".($errors->has('legal_name')?" is-invalid":""),"autofocus",'placeholder'=>'Legal name']) !!}
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::text("trading_name",null,["class"=>"form-control".($errors->has('trading_name')?" is-invalid":""),'placeholder'=>'Trading name']) !!}
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::select("business_type", $businessType, null,["class"=>"form-control".($errors->has('business_type')?" is-invalid":""),'placeholder'=>'Business type']) !!}
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        {!! Form::label('representative_first_name', 'Representative first name', ['class' => 'form-label label-required']) !!}
        {!! Form::text("representative_first_name",null,["class"=>"form-control".($errors->has('representative_first_name')?" is-invalid":""),'placeholder'=>'Representative first name']) !!}
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        {!! Form::label('representative_last_name', 'Representative last name', ['class' => 'form-label label-required']) !!}
        {!! Form::text("representative_last_name",null,["class"=>"form-control".($errors->has('representative_last_name')?" is-invalid":""),'placeholder'=>'Representative last name']) !!}
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::select("founding_year",$foundingYears, null,["class"=>"form-control".($errors->has('founding_year')?" is-invalid":""),'placeholder'=>'Founding year']) !!}
    ...
    <!-- <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::text("geographical_target",null,["class"=>"form-control".($errors->has('geographical_target')?" is-invalid":""),'placeholder'=>'Geographical target']) !!}
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::text("website",null,["class"=>"form-control".($errors->has('website')?" is-invalid":""),'placeholder'=>'Website']) !!}
...
<!-- <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::text("company_size",null,["class"=>"form-control".($errors->has('company_size')?" is-invalid":""),'placeholder'=>'Company size']) !!}
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
        ...
        {!! Form::text("audience",null,["class"=>"form-control".($errors->has('audience')?" is-invalid":""),'placeholder'=>'Audience']) !!}
...
<div class="row">
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 form-group">
        {!! Form::label('product_service_offered', 'What kind of products / services does your company offer?', ['class' => 'form-label label-required']) !!}
        {!! Form::textarea("product_service_offered",null,["class"=>"form-control".($errors->has('product_service_offered')?" is-invalid":""),'placeholder'=>'What kind of products / services does your company offer?', 'rows' => 3]) !!}
...
<div class="form-group row">
    <div class="col-xs-12 col-lg-12">
        {!! Form::submit("Update",["type" => "submit","class"=>"btn btn-primary", 'name' => 'save_exit'])!!}
    </div>
</div>
{!! Form::close() !!}