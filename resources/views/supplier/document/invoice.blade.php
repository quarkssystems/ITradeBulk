    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr class="details">
                    ...
                    <td> {{ $product_info['qty'] }}
                        <div class="showEdit{{ $product_info['product_id'] }}" style="display: none">
                            {!! Form::open(['route' => 'picking-doc-Update']) !!}
                            ...
                            {!! Form::hidden('shipment_amount', $product_info['shippingTotal']) !!}
            ...
            <tr class="font-weight-bold">
                ...
                <td>{{ __('Shipping: ') }}</td>
                <td></td>
                <td>R {{ number_format($product_info['shippingTotal'], 2, '.', ',') }}
            ...
            <tr class="font-weight-bold">
                ...
                <td><input type="button" onclick="printDiv('invoice-box')" class="btn btn-sm btn-warning float-right"
                        value="Print" /></td>
                <td><a href="{{ route('reset_picking_doc', [$product_info['order_id']]) }}"
