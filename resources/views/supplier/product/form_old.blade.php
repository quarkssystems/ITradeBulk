                    ...
                    <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
                        <div class="row">
                            ...
                            {!! Form::hidden("status", "INACTIVE") !!}
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 form-group required">
                                        {!! Form::label('stock_type', 'Stock Type', ['class' => 'form-label']) !!}
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 form-group required">
                                        {!! Form::label('stock_of', 'Stock of', ['class' => 'form-label label-required ']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
                                ...
                                {!! Form::select("brand_id",$brands, null,["placeholder"=>"Select Manufacturer", "class"=>"form-control".($errors->has('brand_id')?" is-invalid":""),"autofocus"]) !!}
