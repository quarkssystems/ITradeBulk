        ...
        <div class="container-fluid p-0">
            <div class="row m-0">
                <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 p-0">
                    <img src="{{asset('assets/frontend/images/banners/become-vendor-banner.png')}}" style="width:100%">
                </div>
            </div>
        </div>
    </section>
...
{{--                        </div>--}}
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-lg-12">
                            {!! Form::submit("Submit request to become Trader",["type" => "submit","class"=>"btn btn-danger btn-sm btn-block text-uppercase", 'name' => 'save_continue'])!!}
...
{{--                            {!! Form::button("Reset",["type" => "reset","class"=>"btn btn-warning btn-sm"])!!}--}}
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <img src="{{asset('assets/frontend/images/become-vendor-side-image.png')}}">
                </div>
            </div>
            {!! Form::close() !!}
        </div>
