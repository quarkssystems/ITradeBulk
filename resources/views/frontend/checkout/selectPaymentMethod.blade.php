        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <h3 class="mb-4"><b>{{ __('Payment Summary') }}</b></h3>
            ...
            <div class='row'>
                ...
                @include('frontend.checkout.invoice')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#paymentLoaderModal').on('shown.bs.modal', function(e) {
                ...
                let delivery_status = $(".payment-order-button").data('delivery_status');
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        weight: weight,
                        itemTax: itemTax,
                        delivery_requested: delivery_status
                    },
