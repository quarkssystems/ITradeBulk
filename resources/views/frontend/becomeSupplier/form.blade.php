        ...
        <div class="container-fluid p-0">
            <div class="row m-0">
                <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 p-0">
                    <img src="{{ asset('assets/frontend/images/banners/become-supplier-banner.png') }}" style="width:100%">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::text('company[legal_name]', null, [
                                'class' => 'form-control' . ($errors->has('company.legal_name') ? ' is-invalid' : ''),
                                'autofocus',
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::text('company[trading_name]', null, [
                                'class' => 'form-control' . ($errors->has('company.trading_name') ? ' is-invalid' : ''),
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::select('company[business_type]', $businessType, null, [
                                'class' => 'form-control' . ($errors->has('company.business_type') ? ' is-invalid' : ''),
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::select('company[founding_year]', $foundingYears, null, [
                                'class' => 'form-control' . ($errors->has('company.founding_year') ? ' is-invalid' : ''),
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            {!! Form::label('company[representative_first_name]', 'Representative first name', [
                                'class' => 'form-label label-required',
                            ]) !!}
                            {!! Form::text('company[representative_first_name]', null, [
                                'class' => 'form-control' . ($errors->has('company.representative_first_name') ? ' is-invalid' : ''),
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            {!! Form::label('company[representative_last_name]', 'Representative last name', [
                                'class' => 'form-label label-required',
                            ]) !!}
                            {!! Form::text('company[representative_last_name]', null, [
                                'class' => 'form-control' . ($errors->has('company.representative_last_name') ? ' is-invalid' : ''),
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::text('company[website]', null, [
                                'class' => 'form-control' . ($errors->has('company.website') ? ' is-invalid' : ''),
                                'placeholder' => 'Website',
                            ]) !!}
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::email('company[email]', null, [
                                'class' => 'form-control' . ($errors->has('company.email') ? ' is-invalid' : ''),
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::text('company[address1]', null, [
                                'class' => 'form-control' . ($errors->has('company.address1') ? ' is-invalid' : ''),
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::text('company[address2]', null, [
                                'class' => 'form-control' . ($errors->has('company.address2') ? ' is-invalid' : ''),
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                            {!! Form::label(
                                'company[product_service_offered]',
                                'What kind of products / services does your company offer?',
                                ['class' => 'form-label label-required'],
                            ) !!}
                            {!! Form::textarea('company[product_service_offered]', null, [
                                'class' => 'form-control' . ($errors->has('company.product_service_offered') ? ' is-invalid' : ''),
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-lg-12">
                            {!! Form::submit('Submit request to become supplier', [
                                'type' => 'submit',
