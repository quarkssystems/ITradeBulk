...
@section('content')
    <section class="inner-banner before primary-bg bg-cover bg-bottom text-center contact-page-banner"
        style="background-image:url({{ asset($banner) }}) !important">
        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h1 class="text-uppercase font-weight-bold" style="color: #ffffff">Contact us</h1>
        ...
        <div class="container-fluid  contact-section-3" style="background-color: #EAEAEA">
            ...
            <div class="row row-eq-height">
                ...
                <div class="col-md-12 col-lg-7  form">
                    ...
                    <h2 class="mb-4"><b>FEEL FREE TO DROP US A MESSAGE</b></h2>

                    {{-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.</p> --}}



                    <form class="mt-5" id="contact-form" action="{{ route('contact-submit') }}" method="post">
                        @csrf
                        <div class="container-fluid no-padding">
                            ...
                            <div class="text-right">
                                <button class="btn btn-theme my-2 my-sm-0 " type="submit">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
