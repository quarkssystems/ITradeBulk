        ...
        <div class="container-fluid p-0">
            <div class="row m-0">
                <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 p-0">
                    <img src="{{asset('assets/frontend/images/banners/become-picker-banner.png')}}" style="width:100%">
                </div>
            </div>
        </div>
    </section>
...
{{--                        </div>--}}
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-lg-12">
                            {!! Form::submit("Submit request to become picker",["type" => "submit","class"=>"btn btn-danger btn-sm btn-block text-uppercase", 'name' => 'save_continue'])!!}
