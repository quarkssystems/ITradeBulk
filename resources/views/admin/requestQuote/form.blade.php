...
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-body">
                    @if(isset($cmsblock->uuid) && (isset($copy) && !$copy))
                        {!! Form::model($cmsblock, ['route' => ["$route.update", $cmsblock->uuid], 'method'=>'PUT','id'=>'form', 'autocomplete' => 'off', 'files' => true]) !!}
                    @else
                        {!! Form::model($cmsblock, ['route' => ["$route.store"], 'id'=>'form', 'autocomplete' => 'off', 'name' => 'usersForm', 'files' => true]) !!}
                    @endif
                    <input autocomplete="off" name="hidden" type="text" style="display: none">

                        @if(isset($cmsblock->uuid))
                            {!! Form::hidden('uuid', $cmsblock->uuid) !!}
                        @endif
                    <div class="row">
