...
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-body">
                    @if(isset($product_unit->id) && (isset($copy) && !$copy))
                        {!! Form::model($product_unit, ['route' => ["$route.update", $product_unit->uuid], 'method'=>'PUT','id'=>'form', 'autocomplete' => 'off', 'name' => 'usersForm', 'files' => true]) !!}
                    @else
                        {!! Form::model($product_unit, ['route' => ["$route.store"], 'id'=>'form', 'autocomplete' => 'off', 'name' => 'usersForm', 'files' => true]) !!}
                    @endif
                    <input autocomplete="off" name="hidden" type="text" style="display: none">

                        @if(isset($product_unit->id))
                            {!! Form::hidden('uuid', $product_unit->uuid) !!}
                        @endif
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
                            ...
                            {!! Form::text("unit",null,["class"=>"form-control".($errors->has('unit')?" is-invalid":""),"autofocus",'placeholder'=>'Unit']) !!}
