            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if(isset($user_tax_detail->id))
                        {!! Form::model($user_tax_detail, ['route' => ["$route.update", $user->uuid, $user_tax_detail->uuid], 'method'=>'PUT','id'=>'form', 'autocomplete' => 'off', 'name' => 'usersForm', 'files' => true]) !!}
                    @else
                        {!! Form::model($user_tax_detail, ['route' => ["$route.store", $user->uuid], 'id'=>'form', 'autocomplete' => 'off', 'name' => 'usersForm', 'files' => true]) !!}
                    @endif
