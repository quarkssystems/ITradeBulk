...
@section('header')
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            {{-- <a href="{{ route("$route.create") }}" class="btn btn-info">{{ __('ADD PRODUCT') }}</a> --}}
            {{-- <a href="{{ route('admin.req-pro') }}" class="btn btn-info">{{ __('Requested Product') }}</a> --}}
            <a href="{{ route('admin.hierarchyimport') }}" class="btn btn-success float-right"
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <div class="data-grid">
                        @include('admin.data_hierarchy.grid')
                    </div>
                </div>
            </div>
        </div>
