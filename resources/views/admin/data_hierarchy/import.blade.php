...
@section('header')
    <div class="row">
        ...
        <div class="col-lg-7 col-md-10">
            ...
            <a href="{{ route('admin.data-hierarchy.index') }}" class="btn btn-info">{{ __('Back') }}</a>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open([
                        'route' => ['admin.import_data_hierarchy'],
                        'id' => 'form',
                        'autocomplete' => 'off',
                        'name' => 'importForm',
                        'files' => true,
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-lg-12">
                            ...
                            {!! Form::submit('Import Hierarchy', ['type' => 'submit', 'class' => 'btn btn-primary', 'name' => 'save_exit']) !!}
                    ...
                    <a href="{{ url('/') }}/uploads/Import_Hierarchy.xlsx" download="Import_Hierarchy.xlsx">Download
                        Sample File</a>
