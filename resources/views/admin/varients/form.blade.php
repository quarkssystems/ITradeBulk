                        ...
                        <div class="tab-pane fade show active" id="basic_details" role="tabpanel"
                            ...
                            <div class="row collapse show" id="productBasicDetails" aria-expanded="true">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                                    {!! Form::label('colour', 'Colour', ['class' => 'form-label ']) !!}
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                                    {!! Form::label('colour_variants', 'Colour Variants', ['class' => 'form-label ']) !!}
                                    {{-- {!! Form::label('brand_id', 'Manufacturer', ['class' => 'form-label ']) !!} --}}
                                    {!! Form::text('colour_variants', null, [
                                        'class' => 'form-control' . ($errors->has('colour_variants') ? ' is-invalid' : ''),
                                        'autofocus',
                            ...
                            <div class="row collapse show" id="productBasicDetails" aria-expanded="true">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                                    {!! Form::label('size_variants', 'Size Variants', ['class' => 'form-label ']) !!}
                                    {{-- {!! Form::label('brand_id', 'Manufacturer', ['class' => 'form-label ']) !!} --}}
                                    {!! Form::text('size_variants', null, [
                                        'class' => 'form-control' . ($errors->has('size_variants') ? ' is-invalid' : ''),
                                        'autofocus',
