        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-body">
                        ...
                        @csrf
                         ...
                         <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
                                    ...
                                    {!! Form::file("csv_import",null,["class"=>"form-control".($errors->has('csv_import')?" is-invalid":""),"autofocus",'placeholder'=>'Csv Import']) !!}
                                    <br>
                    ...
                    {!! Form::close() !!}
                    <a href="{{ url('/') }}/uploads/importproductsimple.csv" download="importproductsimple.csv" >Download Simple File</a>
