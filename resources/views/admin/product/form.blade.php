                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row collapse show" id="productBasicDetails" aria-expanded="true">
                                <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
                                    <div class="row">
                                        ...
                                        @if (isset($quickView) && $quickView->product_codes == '0')
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                                ...
                                <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
                                    <div class="form-group row">
                                        @if (isset($quickView) && $quickView->product_description == '0')
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                                        ...
                                        @endif
                                        @if (isset($quickView) && $quickView->image_management == '0')
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                        ...
                        <div class="tab-pane fade" id="add_variants" role="tabpanel"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required">
                                ...
                                <select name="varients" id="" class="form-control varients">
                                    <option value="">Select varient</option>
                                    @foreach ($product->getStockProductAttribute() as $key => $val)
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row collapse" id="productMediaDetails" aria-expanded="false">
                                        <div class="col-xs-12 col-md-12 col-sm-12 col-lg-12">
                                            <div class="form-group row">
                                                <div
                                                    class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group required imageShow">
                                                    {{-- {!! Form::label('base_image_file', 'Base image', ['class' => 'form-label label-required']) !!}
                                                    {!! Form::file('base_image_file', [
                                                        'class' => 'form-control dropify ' . ($errors->has('base_image_file') ? ' is-invalid' : ''),
                                                    ]) !!}
                                                    ...
                                                    @endif --}}
                                                    {!! Form::label('base_image_file_class', 'Base image', ['class' => 'form-label label-required']) !!}
                                                    {!! Form::file('base_image_file_class', [
                                                        'class' => 'form-control dropify base_image_file_class' . ($errors->has('base_image_file') ? ' is-invalid' : ''),
                                                        'data-default-file' => '',
                                                        // 'data-default-file' => isset($product->id) && (isset($copy) && !$copy) ? $product->base_image : '',
                                                    ]) !!}
                                                    <small><i>{{ __('Only JPG and PNG supported') }}</i></small>
