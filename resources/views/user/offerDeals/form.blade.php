                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group required">
                                    ...
                                    {{-- <select name="user_id" id="user_id" disabled class="form-control">
                                        <option value="{{ auth()->user()->uuid }}" selected>
                                            {{ auth()->user()->first_name }}
                                        </option>
                                    </select> --}}
                                    {{-- <input type="text" name="user_id" id="user_id" value="{{ auth()->user()->uuid }}"> --}}
                                    ...
                                    {{-- {!! Form::select('user_id', ['key' => auth()->user()->uuid, 'value' => auth()->user()->first_name], null, [
                                        'class' => 'form-control',
                                        'autofocus',
                                    ]) !!} --}}
