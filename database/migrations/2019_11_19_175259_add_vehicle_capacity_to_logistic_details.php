...
class AddVehicleCapacityToLogisticDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('logistic_details', function (Blueprint $table) {
            $table->dropForeign('logistic_details_vehicle_capacity_id_foreign');
            $table->dropIndex('logistic_details_vehicle_capacity_id_index');
