...
class CreateOrderLogisticQueueHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('order_logistic_queue_histories', function (Blueprint $table) {
            //
            $userModel = new User();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('order_logistic_queue_histories');
    }
}
