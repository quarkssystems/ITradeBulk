...
class CreateDispatchedDocumentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dispatched_documents', function (Blueprint $table) {
            $table->increments('id');
            $table->uuid('uuid');
            $table->index('uuid');
    ...
    {
        Schema::dropIfExists('dispatched_documents');
    }
}