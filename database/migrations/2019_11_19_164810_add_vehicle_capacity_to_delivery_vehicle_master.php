...
class AddVehicleCapacityToDeliveryVehicleMaster extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('delivery_vehicle_masters', function (Blueprint $table) {
            $table->dropForeign('delivery_vehicle_masters_vehicle_capacity_id_foreign');
            $table->dropIndex('delivery_vehicle_masters_vehicle_capacity_id_index');
