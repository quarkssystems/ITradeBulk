...
/* on click scale effect */
$(function() {
    $("img").on("click", function(e) {  // See here, i have our selector set to "li", so this jQuery object will grab all li tags on the page
        $(this).addClass("scale-effect").siblings().removeClass("scale-effect");
    });
})
/* on click scale effect */
