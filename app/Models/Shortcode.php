...
use App\Models\History\ShortcodeHistory;
...
class Shortcode extends Model
{
    ...
    protected static function boot() : void
    {
        ...
        static::created(function ($model) {
            $model->createUserLog($model, 'userActivity.shortcode|created');
        ...
        static::updated(function($model){
            ...
            {
                $model->generateHistory($model);
                $model->createUserLog($model, 'userActivity.shortcode|updated');
            }
        });
    ...
    {
        return $this->hasMany(ShortcodeHistory::class, "history_of", 'id');
    }
