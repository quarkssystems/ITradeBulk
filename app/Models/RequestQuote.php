...
class RequestQuote extends Model
{
    ...
    protected static function boot() : void
    {
        ...
        static::created(function ($model) {
            $model->createUserLog($model, 'userActivity.requestQuote|created');
//            $model->generateHistory($model);
        ...
        static::updated(function($model){
            ...
            {
//                $model->generateHistory($model);
                $model->createUserLog($model, 'userActivity.requestQuote|updated');
            }
        });
    ...
    {
        return $this->hasMany(RequestQuoteHistory::class, "history_of", 'uuid');
    }
