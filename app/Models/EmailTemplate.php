...
use App\Models\History\EmailTemplateHistory;
...
class EmailTemplate extends Model
{
    ...
    protected static function boot() : void
    {
        ...
        static::created(function ($model) {
            $model->createUserLog($model, 'userActivity.email_template|created');
        ...
        static::updated(function($model){
            ...
            {
                $model->generateHistory($model);
                $model->createUserLog($model, 'userActivity.email_template|updated');
            }
        });
    ...
    {
        return $this->hasMany(EmailTemplateHistory::class, "history_of", 'id');
    }
