...
class ProductCodesController extends Controller
{
    ...
    public $dataUrl = '/admin/product-code';

    public $route = 'admin.product-code';
    ...
    public function index(Request $request, Product $productModel, Excel $excel, Brand $brandModel, User $userModel)
    {
        ...
        if ($request->ajax()) {
            return view('admin.product_code.grid', compact('data', 'dataGridTitle', 'dataGridSearch', 'dataGridPagination', 'route'));
        } else {
            return view('admin.product_code.index', compact('data', 'dataGridTitle', 'dataGridSearch', 'dataGridPagination', 'pageTitle', 'route'));
        }
    }
    ...
    public function edit($id, Brand $brandModel, Tax $taxModel, Category $categoryModel, ProductUnit $productUnitModel)
    {
        ...
        $route = $this->route;
        $role = auth()->user()->role;
        return view('admin.product_code.form', compact('product', 'pageTitle', 'route'));
    }
